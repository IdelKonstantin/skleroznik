...
//------------------------------------------------
#define BE16_TO_WORD(a) ((((a)>>8)&0xff)|(((a)<<8)&0xff00))
#define BE24_TO_WORD(a) ((((a)>>16)&0x000000ff)|((a)&0x0000ff00)|(((a)<<16)&0x00ff0000))
...
private:
  ...
  _bme280::BME280_CalibData CalibData{};
  int32_t temper_int{};
  HAL_StatusTypeDef status{};
  void(*errorHandlerCallback)(void){nullptr};
...
public:
  ...
  void Init();
  void SetErrorHandler(void(*func)(void));
