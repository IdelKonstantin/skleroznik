...
using fx16q16_t = int32_t;

#define MAKE_FROM_FLOAT(a)  ((fx16q16_t)((a) * (1LL << 16)))
#define CONVERT_TO_FLOAT(a) ((a) / (float)(1LL<<16))

#define MULT(a, b) ((fx16q16_t)(((int64_t)(a) * (b)) >> 16))
#define DIV(a, b) ((fx16q16_t)(((int64_t)(a) << 16) / (b)))
